...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'signin.connectOAuth': 'Connect with Craft World',
    'signin.error.denied': 'Authorization was denied by Craft World.',
    'signin.error.server': 'Craft World OAuth error.',

    // Settings
    'settings.title': 'Settings',
    'settings.savedDesc':
      'Saved player setup is stored locally in this browser and survives refreshes.',
    ...
    'home.connectDesc':
      'Link your Craft World UID to import your in-game assets, factories, and levels automatically.',
    ...
    'prices.calcDescription':
      'Convert amounts or change the base COIN conversion price to dynamically update all USD references across the list.',
  ...
  es: {
    ...
    'signin.connectOAuth': 'Conectar con Craft World',
    'signin.error.denied': 'La autorización fue denegada por Craft World.',
    'signin.error.server': 'Error de OAuth con Craft World.',

    // Settings
    'settings.title': 'Configuración',
    'settings.savedDesc':
      'La configuración del jugador se guarda localmente en este navegador y sobrevive a los reinicios.',
    ...
    'home.connectDesc':
      'Vincula tu UID de Craft World para importar tus recursos, fábricas y niveles del juego automáticamente.',
    ...
    'home.showingProf':
      'Mostrando la cantidad recolectada y el nivel de maestría reclamado devuelto por Craft World.',
    ...
    'prices.calcDescription':
      'Convierte cantidades o cambia el precio base de conversión de COIN para actualizar de manera dinámica todos los valores de referencia en USD en la lista.',
...
const dictionaryTranslation: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    'Showing collected amount and claimed proficiency level returned by Craft World.':
      'Mostrando la cantidad recolectada y el nivel de maestría reclamado devueltos por Craft World.',
    ...
    'No factory production rows are ready yet.':
      'No hay filas de producción de fábrica listas aún.',
    ...
    'No recipe row found for that dropdown selection.':
      'No se encontró fila de receta para esa selección.',
    'Choose the resource, choose the factory level, then type the amount you want.':
      'Elige el recurso, elige el nivel de la fábrica y escribe la cantidad deseada.',
    ...
    'No fully quoted factory recommendation is available yet.':
      'No hay recomendación de fábrica cotizada disponible aún.',
